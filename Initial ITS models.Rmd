...
summary(modScot99_07_null)$tTable
```
...
summary(modScotPI_99_07_null)$tTable
```
```{r echo=FALSE, message=FALSE}
...
summary(modWal99_07_null)$tTable
```
```{r echo=FALSE, message=FALSE}
...
summary(modWalPI_99_07_null)$tTable
```
```{r echo=FALSE, message=FALSE}
