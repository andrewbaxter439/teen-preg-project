...
A further iterative cycle constructed sequential synthetic controls, removing the previous top-weighted country to test for over-reliance on very few abnormal countries. Labels represent the top-weighted country in each analysis by weight and pre-itervention MSPE:
