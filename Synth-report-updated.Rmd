...
if (params$save_graphs){ggsave("graphs/Synth-u18-ns.svg", gr_u18_ns, width = 200, height = 150, units = "mm")}
...
gr_u20_ns# + labs(title = sPredText(dp_u20_ns))
 if (params$save_graphs){ggsave("graphs/Synth-u20-sp.svg", gr_u20_ns, width = 200, height = 150, units = "mm")}
```
