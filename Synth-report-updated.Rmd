...
pp_u18_sp + labs(title = "Post/pre-TPS mean squared prediction error") 
...
pp_u20_sp+ labs(title = "Post/pre-TPS mean squared prediction error") 
...
pp_u18_ns + labs(title = "Post/pre-TPS mean squared prediction error") 
...
pp_u20_ns+ labs(title = "Post/pre-TPS mean squared prediction error") 
...
pp_u18_all+ labs(title = "Post/pre-TPS mean squared prediction error") 
...
pp_u20_all+ labs(title = "Post/pre-TPS mean squared prediction error")
